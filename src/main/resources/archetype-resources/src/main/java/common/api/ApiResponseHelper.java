...
public class ApiResponseHelper {
   ...
   */
  public static ApiResponse<ErrorApiResponseBody> buildErrorApiResponse(HttpStatus status,
      String message, Exception exception, List<? extends ApiErrorDetails> errorDetails) {
  ...
  private static <E extends ApiErrorDetails> ErrorApiResponseBody generateErrorResponseBody(
      HttpStatus status, String message, List<E> errors) {
