...
public class ApiResponseUtils {
  ...
  public static void assertApiResponseIsPermissionException(ResultActions testResults,
  ...
  public static void assertApiResponseIsSuccessWithEmptyData(ResultActions testResults)
      throws Exception {
    String now = LocalDateTime.now().format(DateTimeFormatter.ISO_DATE_TIME);
